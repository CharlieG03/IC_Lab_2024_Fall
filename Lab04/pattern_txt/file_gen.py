...
# File paths
Img_file_path = r'Img.txt'
Ke1_file_path = r'Kernel_ch1.txt'
Ke2_file_path = r'Kernel_ch2.txt'
Wei_file_path = r'Weight.txt'
Opt_file_path = r'Opt.txt'

Out_file_path = r'Out.txt'
...
for patcount in range(PATNUM):
    ...
    write_to_file(patcount, feature_map0, feature_map1, feature_map2, kernel0_ch1, kernel0_ch2, kernel1_ch1, kernel1_ch2, kernel2_ch1, kernel2_ch2, weight_ch1, weight_ch2, weight_ch3, opt)
